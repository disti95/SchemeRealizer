<?php 
	...
	*/
	...
	function getView($type) {
		$viewlabel = ($type == "class") ? "PHP-File/Class:" : "Table:";
		$viewid = ($type == "class")    ? "phpFileClass"    : "table";
		echo <<<UMLVIEW
		<div id="showAttrMeth">
			<div class="form-group">
				<h3><label for="$viewid">$viewlabel</label></h3>
				<select id="$viewid" class="form-control" onchange="setAttrMethPerFile('uml');">
				</select>
			</div>
			<hr/>
			<div class="form-group">
			...
			<hr/>
			<div class="radio">
				<label><input type="radio" id="type" name="type" value=3>PNG</label>
			</div>
			<div class="radio">
				<label><input type="radio" id="type" name="type" value=2>JPG</label>
			</div>
			<div class="radio">
				<label><input type="radio" id="type" name="type" value=1>TXT</label>
			</div>
			<button onclick="getUML(0, 0, 0)" id="exportUML" class="btn btn-primary">Add!</button>
			<button onclick="getUML(1, 0, 0)" id="exportUML" class="btn btn-primary">Remove!</button>
			<button onclick="getUML(0, 0, 1)" id="exportUML" class="btn btn-primary">Show All!</button>
			<button onclick="getUML(0, 1, 0)" id="exportUML" class="btn btn-primary">Flush!</button>
		</div>
UMLVIEW;
	}
?>
